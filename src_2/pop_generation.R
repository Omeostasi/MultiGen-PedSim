...
### ---------
###  IN VERSION 2, THESE FUNCCTIONS USE VECTORS AS INPUTS FOR lambdaKids and p_new_partner
### ---------
...
pop_generation <- function(pop_founder_haplo, overlapping_fraction = 0, nGenerations_pop = 3, mothers_fraction = 0.75, lambdaKids = c(2.3, 2.0, 1.6), maxPartners_mom = 3, p_new_partner = c(0.05, 0.10, 0.25), mean_unions_dad = 1.3){
  #
  ...
  from_founders <- pop_generation_from_founders(pop_founder_haplo, mothers_fraction = mothers_fraction,
                                                ...
                                                p_new_partner = p_new_partner[1], mean_unions_dad = mean_unions_dad)
