...
# This must be modified because mothers and children are not anymore present.
# 2 ideas: 
# 1) store them sequentially during the pop_generation
# 2) store them after pop generation, then mothers are all the mothers, but what is children?

# We decided it will be 2)
