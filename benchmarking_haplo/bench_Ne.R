...
threads_range <- c(16) # Best value

# effective pop size
Ne_range <- c(seq(from=0, to= 12000, by=500)[-1]) # Best value is 10000, but we want to see the effect of different Ne values)
...
saveRDS(comparison_by_param, file="results/bench_Ne.rds")
