...
# source("src_4/helpers_juan.R")

### ---------
###  IN VERSION 3, THESE FUNCCTIONS USE VECTORS AS INPUTS FOR lambdaKids, p_new_partner, mean_unions_dad and mothers_fraction
###  IN VERSION 4, THESE FUNCTIONS HAVE BEEN MODIFIED TO REMOVE THE FOUNDERS AND 80% OF THE SILENT GENERATION FROM THE FINAL OUTPUT 
